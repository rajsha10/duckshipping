    ...
    <div className="max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="items-start justify-between md:flex">
        ...
        <div className="mt-3 md:mt-0">
          ...
          className="inline-block px-4 py-2 text-white duration-150 font-medium bg-gray-800 hover:gray-700 active:bg-gray-900 md:text-sm rounded-lg md:inline-flex">
            Add Duck Tracking
          </p>
        </div>
      </div>
