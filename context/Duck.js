...
//INTERNAL IMPORT
import duck from "../Context/Duck.json";
...
export const DuckContext = React.createContext();

export const DuckProvider = ({ children }) => {
    //STATE VARIABLE  
    const DappName = "Product Duck Dapp";
    ...
    const getAllShipment = async () => {
        try{
            ...
            const allShipments = shipments.map((shipment) => ({
                ...
                price: ethers.utils.formatWther(shipment.price.toString()),
